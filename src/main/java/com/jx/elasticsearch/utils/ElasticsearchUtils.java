...
public class ElasticsearchUtils {
     ...
     */
    public static void batchInsertData(String index, String type, Map<String, String> data) {
     ...
     * @param jsonList 批量数据
     */
    public static void batchInsertData(String index, String type, List<String> jsonList) {
        BulkRequestBuilder bulkRequest = client.prepareBulk();
     ...
     */
    public static List<Map<String, Object>> search(String index, String type, ESQueryBuilderConstructor constructor) {
        List<Map<String, Object>> result = new ArrayList<>();
        SearchRequestBuilder searchRequestBuilder = client.prepareSearch(index).setTypes(type);
        //排序
        if (org.apache.commons.lang.StringUtils.isNotEmpty(constructor.getAsc()))
            searchRequestBuilder.addSort(constructor.getAsc(), SortOrder.ASC);
        if (org.apache.commons.lang.StringUtils.isNotEmpty(constructor.getDesc()))
     ...
     * @param groupBy 统计字段
     */
    public static Map<Object, Object> statSearch(String index, String type, ESQueryBuilderConstructor constructor, String groupBy) {
        ...
        for (Terms.Bucket gradeBucket : stateAgg.getBuckets()) {
     ...
     * @param agg 自定义计算
     */
    public static Map<Object, Object> statSearch(String index, String type, ESQueryBuilderConstructor constructor, AggregationBuilder agg) {
        if (agg == null) {
            return null;
        }
        Map<Object, Object> map = new HashedMap();
